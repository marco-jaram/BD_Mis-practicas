...
SELECT apellido2 from persona p ;
SELECT  nombre from departamento d; 
SELECT * from persona  WHERE  sexo  = 'H';
SELECT * from persona  WHERE  sexo  = 'M';
SELECT * from persona  WHERE  sexo  = 'H' UNION ALL SELECT * from persona  WHERE  sexo  = 'M';
SELECT * from grado  WHERE  nombre  = 'Grado en Ingeniería Mecánica (Plan 2010)' UNION ALL SELECT * from grado  WHERE  nombre  = 'Grado en Química (Plan 2009)';
SELECT * from asignatura a  WHERE  tipo  =  'básica' UNION ALL SELECT * from asignatura  WHERE  tipo  = 'obligatoria';
SELECT  * FROM persona p WHERE tipo = 'profesor'; 

SELECT * from asignatura a  WHERE  tipo  = 'optativa' UNION all SELECT * from asignatura WHERE  nombre  ='Física';

SELECT  * FROM departamento d  WHERE nombre  = 'Derecho' INTERSECT  SELECT * from profesor p;
SELECT  * FROM departamento d  WHERE nombre  = 'Derecho';
SELECT * from asignatura a  WHERE  tipo  = 'optativa' INTERSECT  SELECT * from asignatura WHERE  nombre  ='Derecho';
